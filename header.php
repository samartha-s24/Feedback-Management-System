...
<body class="flex h-screen overflow-hidden text-slate-800 antialiased selection:bg-brand-200 selection:text-brand-900 dark:selection:bg-brand-900 dark:selection:text-brand-100">
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden bg-brand-50/40 dark:bg-slate-900 transition-colors">
        ...
        <!-- Top Navbar -->
        <header class="top-navbar h-16 bg-brand-100/50 dark:bg-slate-800 border-b border-brand-200/50 dark:border-slate-700 flex items-center justify-between px-4 sm:px-6 z-30 flex-shrink-0 shadow-sm">
        ...
        <!-- Wire hamburger button to the sidebar drawer (functions defined in sidebar.php) -->
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                if (toggleBtn) {
                    toggleBtn.addEventListener('click', function (e) {
                        e.stopPropagation();
                        if (typeof toggleFacultySidebar === 'function') {
                            toggleFacultySidebar();
                        }
                    });
                }
            });
